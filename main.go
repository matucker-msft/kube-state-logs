...
func main() {
	...
	var (
		...
		resources       = flag.String("resources", "deployments,pods,services,nodes,replicasets,statefulsets,daemonsets,namespaces,jobs,cronjobs,configmaps,secrets,persistentvolumeclaims,ingresses,horizontalpodautoscalers,serviceaccounts", "Comma-separated list of resources to monitor")
